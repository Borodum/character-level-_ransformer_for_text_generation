...
def temperature_decode(model, start_text, char_to_idx, idx_to_char, device, temperature=1.0, max_length=500, max_context=256):
    if temperature <= 0:
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate temperature scaling on char-level transformer.")
    ...
    parser.add_argument("--report", default="temperature_scaling_report.json")
